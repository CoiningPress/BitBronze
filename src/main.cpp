...
#if defined(NDEBUG)
# error "BitBronze cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xc6776e2f2f0cf456e1e60b20b07eedd6ec53afc741771811554f0cb4eaab6a3d");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // BitBronze: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "BitBronze Signed Message:\n";
...
{
    // BitBronze: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 53600 blocks
    nSubsidy >>= (nHeight / 53600);
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // BitBronze: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // BitBronze: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc6776e2f2f0cf456e1e60b20b07eedd6ec53afc741771811554f0cb4eaab6a3d");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1449668404, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "Gold and Silver why not Bronze";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 42 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0401c0d2a02c1dc3c1c30f0a40184c1eb1bd35d86a916a6da1347eecbfee88d1f751376557fa2d085a36069b011e83febff96fd9e18486896dad5bb4867db3b4df") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1449668404;
        ...
        assert(block.hashMerkleRoot == uint256("0x6e553e51a85ae731f223def185638435a23b818de015e21f747db419773467b4"));
...
unsigned char pchMessageStart[4] = { 0xf5, 0x77, 0x29, 0x49 }; // BitBronze: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BitBronzeMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BitBronzeMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static BitBronzeMiner(CWallet *pwallet)
{
    printf("BitBronzeMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("bitbronze-miner");
    ...
    try { loop {
        ...
        printf("Running BitBronzeMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("BitBronzeMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&BitBronzeMiner, pwallet));
}
